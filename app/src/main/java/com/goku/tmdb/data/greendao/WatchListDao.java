...
/** 
 * DAO for table "WATCH_LIST".
*/
public class WatchListDao extends AbstractDao<WatchList, Long> {

    public static final String TABLENAME = "WATCH_LIST";

    /**
     * Properties of entity WatchList.<br/>
    ...
    public WatchListDao(DaoConfig config) {
        super(config);
    }
    
    public WatchListDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"WATCH_LIST\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"WATCH_LIST\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, WatchList entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, WatchList entity) {
        stmt.clearBindings();
    ...
    @Override
    public WatchList readEntity(Cursor cursor, int offset) {
    ...
    @Override
    public void readEntity(Cursor cursor, WatchList entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(WatchList entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(WatchList entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(WatchList entity) {
